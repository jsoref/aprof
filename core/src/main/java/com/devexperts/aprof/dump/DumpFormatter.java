...
public class DumpFormatter {
  ...
  private final FastObjIntMap<String> classLevel = new FastObjIntMap<>();
  ...
  public void dumpSnapshotByLocations(PrintWriter out, SnapshotRoot ss, String insideOf) {
    // rebuild locations
    locations.clearDeep();
  ...
  // print all info about about ss
  // like  (99.71%) bytes in 1,...
